...
exports.findAll = async (req, res) => {
    ...
    try {
        ...
        console.log("Problem is reading user's products");
    }
};
...
exports.findOne = async (req, res) => {
    ...
    try {
        ...
        res.status(400).json({ status: false, data: err });
        console.log("Problem is finding user's products", username);
    }
};
...
exports.updateProduct = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ status: true, data: result });
        console.log('Success in updating product quantity ');
    } catch (err) {
        res.status(400).json({ status: false, data: err });
...
exports.stats1 = async (req, res) => {
    console.log('For all the users sum by product and count');
